                ...
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form action="{{ route('addCourse') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control" id="courseDescription" name="desctption" required></textarea>

                        </div>

                        <div class="mb-3">
                            <label for="courseimgUrl" class="form-label">IMG URL</label>
                            <input type="text" class="form-control" id="courseimgUrl" name="img_url" required>
